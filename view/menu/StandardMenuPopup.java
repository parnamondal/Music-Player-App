...
final class StandardMenuPopup extends MenuPopup implements OnDismissListener, OnItemClickListener, MenuPresenter, OnKeyListener {
    private static final int ITEM_LAYOUT = C0333R.layout.abc_popup_menu_item_layout;
    ...
    public StandardMenuPopup(Context context, MenuBuilder menu, View anchorView, int popupStyleAttr, int popupStyleRes, boolean overflowOnly) {
        ...
        this.mPopupMaxWidth = Math.max(res.getDisplayMetrics().widthPixels / 2, res.getDimensionPixelSize(C0333R.dimen.abc_config_prefDialogWidth));
        ...
        if (!this.mWasDismissed) {
            ...
            if (view != null) {
                ...
                if (this.mShowTitle && this.mMenu.getHeaderTitle() != null) {
                    FrameLayout titleItemView = (FrameLayout) LayoutInflater.from(this.mContext).inflate(C0333R.layout.abc_popup_menu_header_item_layout, listView, false);
