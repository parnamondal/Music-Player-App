...
public final class ViewPropertyAnimatorCompat {
    ...
    /* renamed from: x */
    public ViewPropertyAnimatorCompat mo4847x(float value) {
        View view = (View) this.mView.get();
        View view2 = view;
        if (view != null) {
    ...
    /* renamed from: y */
    public ViewPropertyAnimatorCompat mo4849y(float value) {
        View view = (View) this.mView.get();
        View view2 = view;
        if (view != null) {
    ...
    /* renamed from: z */
    public ViewPropertyAnimatorCompat mo4851z(float value) {
        View view = (View) this.mView.get();
        View view2 = view;
        if (view != null && VERSION.SDK_INT >= 21) {
