    ...
    private boolean tryOnMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        for (int i3 = 0; i3 < count; i3++) {
            ...
            if (child.getVisibility() != 8) {
                int id = child.getId();
                if (id == C0333R.C0335id.topPanel) {
                    topPanel = child;
                } else if (id == C0333R.C0335id.buttonPanel) {
                    buttonPanel = child;
                } else if ((id != C0333R.C0335id.contentPanel && id != C0333R.C0335id.customPanel) || middlePanel != null) {
                    return false;
                } else {
                    middlePanel = child;
                }
