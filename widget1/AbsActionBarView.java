...
abstract class AbsActionBarView extends ViewGroup {
    ...
    AbsActionBarView(Context context, AttributeSet attrs, int defStyle) {
        ...
        if (!context.getTheme().resolveAttribute(C0333R.attr.actionBarPopupTheme, tv, true) || tv.resourceId == 0) {
    ...
    public void onConfigurationChanged(Configuration newConfig) {
        ...
        TypedArray a = getContext().obtainStyledAttributes(null, C0333R.styleable.ActionBar, C0333R.attr.actionBarStyle, 0);
        setContentHeight(a.getLayoutDimension(C0333R.styleable.ActionBar_height, 0));
        a.recycle();
