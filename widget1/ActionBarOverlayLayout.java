...
public class ActionBarOverlayLayout extends ViewGroup implements DecorContentParent, NestedScrollingParent {
    ...
    static final int[] ATTRS = {C0333R.attr.actionBarSize, 16842841};
    ...
    public void pullChildren() {
        if (this.mContent == null) {
            this.mContent = (ContentFrameLayout) findViewById(C0333R.C0335id.action_bar_activity_content);
            this.mActionBarTop = (ActionBarContainer) findViewById(C0333R.C0335id.action_bar_container);
            this.mDecorToolbar = getDecorToolbar(findViewById(C0333R.C0335id.action_bar));
        }
    }
