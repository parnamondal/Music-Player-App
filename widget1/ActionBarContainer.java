...
public class ActionBarContainer extends FrameLayout {
    ...
    public ActionBarContainer(Context context, AttributeSet attrs) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, C0333R.styleable.ActionBar);
        this.mBackground = a.getDrawable(C0333R.styleable.ActionBar_background);
        this.mStackedBackground = a.getDrawable(C0333R.styleable.ActionBar_backgroundStacked);
        this.mHeight = a.getDimensionPixelSize(C0333R.styleable.ActionBar_height, -1);
        if (getId() == C0333R.C0335id.split_action_bar) {
            this.mIsSplit = true;
            this.mSplitBackground = a.getDrawable(C0333R.styleable.ActionBar_backgroundSplit);
        }
        a.recycle();
        boolean z = false;
    ...
    public void onFinishInflate() {
        ...
        this.mActionBarView = findViewById(C0333R.C0335id.action_bar);
        this.mContextView = findViewById(C0333R.C0335id.action_context_bar);
    }
