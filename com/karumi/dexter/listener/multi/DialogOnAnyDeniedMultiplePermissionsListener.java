...
public class DialogOnAnyDeniedMultiplePermissionsListener extends BaseMultiplePermissionsListener {
    ...
    public static class Builder {
        ...
        public DialogOnAnyDeniedMultiplePermissionsListener build() {
            ...
            DialogOnAnyDeniedMultiplePermissionsListener dialogOnAnyDeniedMultiplePermissionsListener = new DialogOnAnyDeniedMultiplePermissionsListener(this.context, str2, str4, str5, this.icon);
