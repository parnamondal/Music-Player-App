...
final class BackStackRecord extends FragmentTransaction implements BackStackEntry, OpGenerator {
    ...
    @Nullable
    String mName;
    ArrayList<C0204Op> mOps = new ArrayList<>();
    int mPopEnterAnim;
    int mPopExitAnim;
    ...
    static final class C0204Op {
        ...
        C0204Op(int cmd2, Fragment fragment2) {
            this.cmd = cmd2;
    ...
    public void dump(String prefix, PrintWriter writer, boolean full) {
        ...
        if (!this.mOps.isEmpty()) {
            ...
            for (int opNum = 0; opNum < numOps; opNum++) {
                C0204Op op = (C0204Op) this.mOps.get(opNum);
                switch (op.cmd) {
                    case 0:
                        cmdStr = "NULL";
                        break;
    ...
    private void doAddOp(int containerViewId, Fragment fragment, @Nullable String tag, int opcmd) {
        ...
        addOp(new C0204Op(opcmd, fragment));
    }
    ...
    public FragmentTransaction remove(Fragment fragment) {
        addOp(new C0204Op(3, fragment));
        return this;
    }

    public FragmentTransaction hide(Fragment fragment) {
        addOp(new C0204Op(4, fragment));
        return this;
    }

    public FragmentTransaction show(Fragment fragment) {
        addOp(new C0204Op(5, fragment));
        return this;
    }

    public FragmentTransaction detach(Fragment fragment) {
        addOp(new C0204Op(6, fragment));
        return this;
    }

    public FragmentTransaction attach(Fragment fragment) {
        addOp(new C0204Op(7, fragment));
        return this;
    }

    public FragmentTransaction setPrimaryNavigationFragment(@Nullable Fragment fragment) {
        addOp(new C0204Op(8, fragment));
        return this;
    }
            ...
            if (!(container == 0 || container == lastContainer)) {
                ...
                for (int i = startIndex; i < endIndex; i++) {
                    ...
                    for (int thoseOpIndex = 0; thoseOpIndex < numThoseOps; thoseOpIndex++) {
                        C0204Op thatOp = (C0204Op) record.mOps.get(thoseOpIndex);
            ...
            switch (op.cmd) {
                        ...
                        if (old.mContainerId == containerId) {
                            if (old == f) {
                                ...
                                if (old == oldPrimaryNav) {
                                    this.mOps.add(opNum, new C0204Op(9, old));
                                    opNum++;
                                    oldPrimaryNav = null;
                                }
                                C0204Op removeOp = new C0204Op(3, old);
                ...
                case 6:
                    ...
                    if (op.fragment != oldPrimaryNav) {
                        ...
                        this.mOps.add(opNum, new C0204Op(9, op.fragment));
                        opNum++;
                        oldPrimaryNav = null;
                        break;
                    }
                case 8:
                    this.mOps.add(opNum, new C0204Op(9, oldPrimaryNav));
                    opNum++;
    ...
    public boolean isPostponed() {
        for (int opNum = 0; opNum < this.mOps.size(); opNum++) {
            if (isFragmentPostponed((C0204Op) this.mOps.get(opNum))) {
                return true;
            }
        }
        return false;
    ...
    private static boolean isFragmentPostponed(C0204Op op) {
