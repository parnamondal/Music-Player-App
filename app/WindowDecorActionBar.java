...
public class WindowDecorActionBar extends ActionBar implements ActionBarVisibilityCallback {
    ...
    private void init(View decor) {
        this.mOverlayLayout = (ActionBarOverlayLayout) decor.findViewById(C0333R.C0335id.decor_content_parent);
        ActionBarOverlayLayout actionBarOverlayLayout = this.mOverlayLayout;
        if (actionBarOverlayLayout != null) {
            actionBarOverlayLayout.setActionBarVisibilityCallback(this);
        }
        this.mDecorToolbar = getDecorToolbar(decor.findViewById(C0333R.C0335id.action_bar));
        this.mContextView = (ActionBarContextView) decor.findViewById(C0333R.C0335id.action_context_bar);
        this.mContainerView = (ActionBarContainer) decor.findViewById(C0333R.C0335id.action_bar_container);
        ...
        TypedArray a = this.mContext.obtainStyledAttributes(null, C0333R.styleable.ActionBar, C0333R.attr.actionBarStyle, 0);
        if (a.getBoolean(C0333R.styleable.ActionBar_hideOnContentScroll, false)) {
            setHideOnContentScrollEnabled(true);
        }
        int elevation = a.getDimensionPixelSize(C0333R.styleable.ActionBar_elevation, 0);
        if (elevation != 0) {
    ...
    public Context getThemedContext() {
        if (this.mThemedContext == null) {
            ...
            this.mContext.getTheme().resolveAttribute(C0333R.attr.actionBarWidgetTheme, outValue, true);
