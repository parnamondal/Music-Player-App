...
class ViewGroupUtilsApi14 {
    ...
    static void suppressLayout(@NonNull ViewGroup group, boolean suppress) {
        ...
        if (suppress) {
            ...
            if (layoutTransition != null) {
                ...
                if (layoutTransition != sEmptyLayoutTransition) {
                    group.setTag(C0180R.C0182id.transition_layout_save, layoutTransition);
                }
            }
        ...
        LayoutTransition layoutTransition2 = (LayoutTransition) group.getTag(C0180R.C0182id.transition_layout_save);
        if (layoutTransition2 != null) {
            group.setTag(C0180R.C0182id.transition_layout_save, null);
