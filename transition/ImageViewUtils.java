...
class ImageViewUtils {
    ...
    static void startAnimateTransform(ImageView view) {
        if (VERSION.SDK_INT < 21) {
            ...
            view.setTag(C0180R.C0182id.save_scale_type, scaleType);
            if (scaleType == ScaleType.MATRIX) {
                view.setTag(C0180R.C0182id.save_image_matrix, view.getImageMatrix());
            } else {
        ...
        if (VERSION.SDK_INT < 21) {
            animator.addListener(new AnimatorListenerAdapter() {
                public void onAnimationEnd(Animator animation) {
                    ScaleType scaleType = (ScaleType) view.getTag(C0180R.C0182id.save_scale_type);
                    view.setScaleType(scaleType);
                    view.setTag(C0180R.C0182id.save_scale_type, null);
                    if (scaleType == ScaleType.MATRIX) {
                        ImageView imageView = view;
                        imageView.setImageMatrix((Matrix) imageView.getTag(C0180R.C0182id.save_image_matrix));
                        view.setTag(C0180R.C0182id.save_image_matrix, null);
                    }
