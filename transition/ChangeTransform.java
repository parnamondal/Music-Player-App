...
public class ChangeTransform extends Transition {
    ...
    private static class GhostListener extends TransitionListenerAdapter {
        ...
        public void onTransitionEnd(@NonNull Transition transition) {
            ...
            this.mView.setTag(C0180R.C0182id.transition_transform, null);
            this.mView.setTag(C0180R.C0182id.parent_matrix, null);
        }
    ...
    private void captureValues(TransitionValues transitionValues) {
        ...
        if (view.getVisibility() != 8) {
            ...
            if (this.mReparent) {
                ...
                transitionValues.values.put(PROPNAME_INTERMEDIATE_MATRIX, view.getTag(C0180R.C0182id.transition_transform));
                transitionValues.values.put(PROPNAME_INTERMEDIATE_PARENT_MATRIX, view.getTag(C0180R.C0182id.parent_matrix));
            }
        }
    }
    ...
    private ObjectAnimator createTransformAnimator(TransitionValues startValues, TransitionValues endValues, boolean handleParentChange) {
        ...
        C01713 r4 = new AnimatorListenerAdapter() {
            ...
            public void onAnimationEnd(Animator animation) {
                if (!this.mIsCanceled) {
                    if (!z || !ChangeTransform.this.mUseOverlay) {
                        view2.setTag(C0180R.C0182id.transition_transform, null);
                        view2.setTag(C0180R.C0182id.parent_matrix, null);
                    } else {
            ...
            private void setCurrentMatrix(Matrix currentMatrix) {
                ...
                view2.setTag(C0180R.C0182id.transition_transform, this.mTempMatrix);
                transforms2.restore(view2);
            }
        };
    ...
    private void setMatricesForParent(TransitionValues startValues, TransitionValues endValues) {
        ...
        endValues.view.setTag(C0180R.C0182id.parent_matrix, endParentMatrix);
