...
class TranslationAnimationCreator {
    ...
    private static class TransitionPositionListener extends AnimatorListenerAdapter {
        ...
        private int[] mTransitionPosition = ((int[]) this.mViewInHierarchy.getTag(C0180R.C0182id.transition_position));
        ...
        TransitionPositionListener(View movingView, View viewInHierarchy, int startX, int startY, float terminalX, float terminalY) {
            ...
            if (this.mTransitionPosition != null) {
                this.mViewInHierarchy.setTag(C0180R.C0182id.transition_position, null);
            }
        }
        ...
        public void onAnimationCancel(Animator animation) {
            ...
            this.mViewInHierarchy.setTag(C0180R.C0182id.transition_position, this.mTransitionPosition);
        }
    ...
    static Animator createAnimation(View view, TransitionValues values, int viewPosX, int viewPosY, float startX, float startY, float endX, float endY, TimeInterpolator interpolator) {
        ...
        int[] startPosition = (int[]) transitionValues.view.getTag(C0180R.C0182id.transition_position);
