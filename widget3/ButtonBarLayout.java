...
public class ButtonBarLayout extends LinearLayout {
    ...
    public ButtonBarLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        TypedArray ta = context.obtainStyledAttributes(attrs, C0333R.styleable.ButtonBarLayout);
        this.mAllowStacking = ta.getBoolean(C0333R.styleable.ButtonBarLayout_allowStacking, true);
        ta.recycle();
    }
    ...
    private void setStacked(boolean stacked) {
        ...
        View spacer = findViewById(C0333R.C0335id.spacer);
        if (spacer != null) {
