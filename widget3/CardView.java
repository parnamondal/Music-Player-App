...
import android.support.p003v7.cardview.C0336R;
...
public class CardView extends FrameLayout {
    ...
    public CardView(@NonNull Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, C0336R.attr.cardViewStyle);
    }
    ...
    public CardView(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, C0336R.styleable.CardView, defStyleAttr, C0336R.style.CardView);
        if (a.hasValue(C0336R.styleable.CardView_cardBackgroundColor)) {
            backgroundColor = a.getColorStateList(C0336R.styleable.CardView_cardBackgroundColor);
        } else {
            ...
            if (hsv[2] > 0.5f) {
                i = getResources().getColor(C0336R.color.cardview_light_background);
            } else {
                i = getResources().getColor(C0336R.color.cardview_dark_background);
            }
            backgroundColor = ColorStateList.valueOf(i);
        }
        float radius = a.getDimension(C0336R.styleable.CardView_cardCornerRadius, 0.0f);
        float elevation = a.getDimension(C0336R.styleable.CardView_cardElevation, 0.0f);
        float maxElevation2 = a.getDimension(C0336R.styleable.CardView_cardMaxElevation, 0.0f);
        this.mCompatPadding = a.getBoolean(C0336R.styleable.CardView_cardUseCompatPadding, false);
        this.mPreventCornerOverlap = a.getBoolean(C0336R.styleable.CardView_cardPreventCornerOverlap, true);
        int defaultPadding = a.getDimensionPixelSize(C0336R.styleable.CardView_contentPadding, 0);
        this.mContentPadding.left = a.getDimensionPixelSize(C0336R.styleable.CardView_contentPaddingLeft, defaultPadding);
        this.mContentPadding.top = a.getDimensionPixelSize(C0336R.styleable.CardView_contentPaddingTop, defaultPadding);
        this.mContentPadding.right = a.getDimensionPixelSize(C0336R.styleable.CardView_contentPaddingRight, defaultPadding);
        this.mContentPadding.bottom = a.getDimensionPixelSize(C0336R.styleable.CardView_contentPaddingBottom, defaultPadding);
        if (elevation > maxElevation2) {
            maxElevation = elevation;
        } else {
            maxElevation = maxElevation2;
        }
        this.mUserSetMinWidth = a.getDimensionPixelSize(C0336R.styleable.CardView_android_minWidth, 0);
        this.mUserSetMinHeight = a.getDimensionPixelSize(C0336R.styleable.CardView_android_minHeight, 0);
        a.recycle();
