...
public class BottomAppBar extends Toolbar implements AttachedBehavior {
    ...
    public BottomAppBar(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        float fabCradleMargin = (float) a.getDimensionPixelOffset(C0044R.styleable.BottomAppBar_fabCradleMargin, 0);
        float fabCornerRadius = (float) a.getDimensionPixelOffset(C0044R.styleable.BottomAppBar_fabCradleRoundedCornerRadius, 0);
        float fabVerticalOffset = (float) a.getDimensionPixelOffset(C0044R.styleable.BottomAppBar_fabCradleVerticalOffset, 0);
