...
public class BottomSheetDialog extends AppCompatDialog {
    ...
    private View wrapInBottomSheet(int layoutResId, View view, LayoutParams params) {
        FrameLayout container = (FrameLayout) View.inflate(getContext(), C0044R.layout.design_bottom_sheet_dialog, null);
        ...
        coordinator.findViewById(C0044R.C0046id.touch_outside).setOnClickListener(new OnClickListener() {
