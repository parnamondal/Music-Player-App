...
public final class CollapsingTextHelper {
    ...
    public void setCollapsedTextAppearance(int resId) {
        TintTypedArray a = TintTypedArray.obtainStyledAttributes(this.view.getContext(), resId, C0333R.styleable.TextAppearance);
        if (a.hasValue(C0333R.styleable.TextAppearance_android_textColor)) {
            this.collapsedTextColor = a.getColorStateList(C0333R.styleable.TextAppearance_android_textColor);
        }
        if (a.hasValue(C0333R.styleable.TextAppearance_android_textSize)) {
            this.collapsedTextSize = (float) a.getDimensionPixelSize(C0333R.styleable.TextAppearance_android_textSize, (int) this.collapsedTextSize);
        }
        this.collapsedShadowColor = a.getInt(C0333R.styleable.TextAppearance_android_shadowColor, 0);
        this.collapsedShadowDx = a.getFloat(C0333R.styleable.TextAppearance_android_shadowDx, 0.0f);
        this.collapsedShadowDy = a.getFloat(C0333R.styleable.TextAppearance_android_shadowDy, 0.0f);
        this.collapsedShadowRadius = a.getFloat(C0333R.styleable.TextAppearance_android_shadowRadius, 0.0f);
        a.recycle();
    ...
    public void setExpandedTextAppearance(int resId) {
        TintTypedArray a = TintTypedArray.obtainStyledAttributes(this.view.getContext(), resId, C0333R.styleable.TextAppearance);
        if (a.hasValue(C0333R.styleable.TextAppearance_android_textColor)) {
            this.expandedTextColor = a.getColorStateList(C0333R.styleable.TextAppearance_android_textColor);
        }
        if (a.hasValue(C0333R.styleable.TextAppearance_android_textSize)) {
            this.expandedTextSize = (float) a.getDimensionPixelSize(C0333R.styleable.TextAppearance_android_textSize, (int) this.expandedTextSize);
        }
        this.expandedShadowColor = a.getInt(C0333R.styleable.TextAppearance_android_shadowColor, 0);
        this.expandedShadowDx = a.getFloat(C0333R.styleable.TextAppearance_android_shadowDx, 0.0f);
        this.expandedShadowDy = a.getFloat(C0333R.styleable.TextAppearance_android_shadowDy, 0.0f);
        this.expandedShadowRadius = a.getFloat(C0333R.styleable.TextAppearance_android_shadowRadius, 0.0f);
        a.recycle();
        if (VERSION.SDK_INT >= 16) {
